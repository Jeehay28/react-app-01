...
const List: React.FC = () => {
  ...
  const baseUrl =
    "https://apis.data.go.kr/B552584/kecoapi/cpointEnrgUsqntStatsService/getGas";
  ...
  return (
    <>
      <Card>
        <h3 style={{color : "#222831", marginTop : '1rem'}}>한국환경공단_탄소중립포인트 에너지 사용량 정보</h3>
        <Table>
          <>
            <thead>
              <tr>
...
export default List;
// https://www.data.go.kr/data/15125026/openapi.do#/API%20%EB%AA%A9%EB%A1%9D/getGas